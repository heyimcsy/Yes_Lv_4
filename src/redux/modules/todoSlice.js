...
export const __getTodoThunk = createAsyncThunk('GET_TODO', async (arg, thunkAPI) => {
  try {
...
export const __updateTodoThunk = createAsyncThunk('UPDATE_TODO', async (arg, thunkAPI) => {
  try {
