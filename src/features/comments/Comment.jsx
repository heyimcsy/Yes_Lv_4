    ...
    <StComment>
      {isEdit ? (
        <>
          ...
          <StControlGroup>
            <Button size="small" bgColor="#FE531F" onClick={onCancelButtonHandler}>
              <Text color="#fff">취소</Text>
            </Button>
            <Button size="small" bgColor="#FE531F" onClick={onUpdateButtonHandler}>
        ...
        <>
          ...
          <StControlGroup>
            <Button size="small" bgColor="#FE531F" disabled={isGlobalEditmode} onClick={onChangeEditButtonHandler}>
              <VscEdit size="16" color="#fff" />
            </Button>
            <Button size="small" bgColor="#FE531F" onClick={onDeleteButtonHandler} disabled={isGlobalEditmode}>
